...
createllm could always use more documentation,
whether as part of the official createllm docs,
in docstrings, or even on the web in blog posts, articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at
<https://github.com/khushaljethava/createllm/issues>.
...
3.  The pull request should work for Python 3.8 and later, and
    for PyPy. Check <https://github.com/khushaljethava/createllm/pull_requests> and make sure that the tests pass for all
